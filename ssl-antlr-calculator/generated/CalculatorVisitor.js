...
export default class CalculatorVisitor extends antlr4.tree.ParseTreeVisitor {
	...
	// Visit a parse tree produced by CalculatorParser#letra.
	visitLetra(ctx) {
	  return this.visitChildren(ctx);
	}


	// Visit a parse tree produced by CalculatorParser#digito.
	visitDigito(ctx) {
	  return this.visitChildren(ctx);
	}


	// Visit a parse tree produced by CalculatorParser#simbolo.
	visitSimbolo(ctx) {
	  return this.visitChildren(ctx);
	}
